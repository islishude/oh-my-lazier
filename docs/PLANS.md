...
| [~] | 7. 实现 Price Bot | price aggregator、deviation check、dst gas price to src token formula、`setPriceConfig` calldata/outbox request builder 已有；Binance/Uniswap clients、gas fetch、定时 enqueue loop 与测试网更新待后续阶段 |
